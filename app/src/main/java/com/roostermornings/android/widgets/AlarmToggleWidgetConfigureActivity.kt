...
/**
 * The configuration screen for the [AlarmToggleWidget] AppWidget.
 */
class AlarmToggleWidgetConfigureActivity : Activity() {
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        setContentView(R.layout.widget_configure_alarm_toggle)
        ...
        mAppWidgetText.setText(loadTitlePref(this@AlarmToggleWidgetConfigureActivity, mAppWidgetId))
    }

    companion object {

        private val PREFS_NAME = "com.roostermornings.android.widgets.AlarmToggleWidget"
